...
const DEFAULT_DATA = {
  heroTitle: "Behind The Design",
  bannerImage: "",
  content: "Step into our studios and witness the architectural precision."
};
...
export default function BehindTheDesignPage() {
  ...
  useEffect(() => {
    fetchDb()
      .then((res) => {
        if (res.custom_pages && res.custom_pages["behind-the-design"]) {
          setPageData({ ...DEFAULT_DATA, ...res.custom_pages["behind-the-design"] });
        }
      })
