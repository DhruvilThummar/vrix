...
<p className="font-body-lg text-body-lg text-on-surface-variant mb-stack-lg max-w-md">
                Our client advisors are available to answer any questions regarding your VRIX experience, from styling advice to order inquiries.
            </p>
...
<a className="font-body-md text-body-md text-deep-navy hover:underline decoration-1 underline-offset-4 transition-all" href="mailto:info@vrixjewels.com">info@vrixjewels.com</a>
</div>
...
<a className="font-body-md text-body-md text-deep-navy hover:underline decoration-1 underline-offset-4 transition-all" href="tel:9054285693">905-428-5693</a>
